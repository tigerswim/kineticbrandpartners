            ...
            <div className="hero__inner">
              <div className="hero__content">
                ...
                <p className="hero__subtitle">
                  ...
                  owning P&amp;Ls from $40MM to $250MM. Now I work with
                  growth-stage companies that need experience and strategic
                  firepower, balanced with a player-coach mindset — on terms
                  that make sense for where they are today.
                </p>
            ...
            <div className="grid grid--2col">
              <div className="card">
                ...
                <p className="card__text">
                  Built and led 25-person marketing organization spanning
              ...
              <div className="card">
                ...
                <p className="card__text">
                  Managed portfolios from $40MM to $250MM. Grew a $250MM brand
                  at 4x the category rate through integrated strategy and
                  execution.
                </p>
              </div>
              <div className="card">
                ...
                <p className="card__text">
                  ...
                  dashboards. Delivered 25% efficiency gains through
                  optimization.
                </p>
              </div>
              <div className="card">
                ...
                <p className="card__text">
                  MarTech implementation (Salsify, Vizit), sales enablement
                  tools, e-commerce/DTC builds. Earned retailer &quot;Best in
                  Class&quot; recognition.
                </p>
              </div>
              <div className="card">
                ...
                <p className="card__text">
                  Clio Award-winning campaigns. 3.95 billion impressions.
                  10-point brand awareness lifts. Creative grounded in strategy.
                </p>
              </div>
              <div className="card">
                <h3 className="card__title">Cross-Functional Leadership</h3>
                <p className="card__text">
                  Player-coach management style. Agency selection and
                  management. Change management across matrixed organizations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="exp-with-logo">
              <div className="logo-item logo-item--central">
                ...
                >
                  ...
                  <path
                    fill="#006e43"
                    d="M206.88,100.67l-5.65,13.65H203l1.26-3.17h7.21l1.27,3.17h1.74l-5.64-13.65Zm-2.1,9.06,3.07-7.33,3.07,7.33Z"
                  />
                  <path
                    fill="#006e43"
                  ...
                  <path
                    fill="#006e43"
                    d="M246.72,100.67h-5.59v13.65h5.57c4.57,0,6.91-2.63,6.91-6.82C253.61,103.47,251.28,100.67,246.72,100.67Zm-.1,12.13h-3.83V102.18h3.83c3.53,0,5.3,2,5.3,5.32S250.15,112.8,246.62,112.8Z"
                  />
                  <polygon
                    fill="#006e43"
              ...
              <div className="exp-with-logo__content">
                ...
                <p className="exp__desc">
                  ...
                  25-person team. Full P&amp;L ownership across multi-brand
                  portfolio.
                </p>
              </div>
            </div>
        ...
        <section id="contact" className="contact section--alt">
          <div className="container">
            ...
            <p className="contact__text">
              Ready to discuss how I can help—or just have a conversation about
