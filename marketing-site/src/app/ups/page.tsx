// UPS Candidate Page
// Live at: kineticbrandpartners.com/ups
            ...
            <div className="mb-capabilities-grid">
              ...
              <div className="kinetic-card">
                ...
                <p className="kinetic-card-text">
                  ...
                  Marketing. Player-coach style: never delegated and
                  disappeared.
                </p>
              </div>
              ...
              <div className="kinetic-card">
                ...
                <p className="kinetic-card-text">
                  ...
                  and C-suites, not just marketing teams. Comfortable in rooms
            ...
            <div className="mb-experience-grid">
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Consumer and Medical Device divisions. Managed $80MM+
                    portfolio across multiple brands. Award-winning campaigns.
                    Translated clinical data into consumer language. A skill
                    built at the intersection of science and storytelling.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    clients. Built the foundation in complex B2B sales cycles
                    and operational thinking that distinguishes how I approach
