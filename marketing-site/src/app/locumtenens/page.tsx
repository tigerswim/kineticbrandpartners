            ...
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                ...
                <p className="mb-subtitle animate-slide-up delay-3">
                  15 years building brands from Fortune 50 to Fortune 1000 -- and
                  never losing sight of the consumer or customer. 
                </p>
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            <div className="kinetic-section-header">
              <span className="kinetic-section-badge">Behavioral Profile</span>
              <h2 className="kinetic-section-title">What the DISC says</h2>
            </div>
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              It's amazing how a 15 minute assessment can accurately pinpoint your working styles. Below
              is how I interpret them for the role at LocumTenens.com.
            </p>
                ...
                <div className="disc-scores">
                  <div className="disc-score-bar">
                    ...
                    <div className="disc-bar-track">
                      <div className="disc-bar-fill disc-bar--d" style={{ width: "45%" }}></div>
                    </div>
                  ...
                  <div className="disc-score-bar">
                    ...
                    <div className="disc-bar-track">
                      <div className="disc-bar-fill disc-bar--i" style={{ width: "62%" }}></div>
                    </div>
                  ...
                  <div className="disc-score-bar">
                    ...
                    <div className="disc-bar-track">
                      <div className="disc-bar-fill disc-bar--s" style={{ width: "68%" }}></div>
                    </div>
                  ...
                  <div className="disc-score-bar">
                    ...
                    <div className="disc-bar-track">
                      <div className="disc-bar-fill disc-bar--c" style={{ width: "36%" }}></div>
                    </div>
                    <span className="disc-score-num">36</span>
                  </div>
                </div>
                <p className="disc-style-note">Natural and adapted styles are nearly identical; I'm the same person in the interview as I am in the office.</p>
              </div>
              ...
              <div className="disc-traits-grid">
                ...
                <div className="disc-trait-card">
                  ...
                  <p className="disc-trait-text">
                    My highest behavioral hierarchy score is persistence (73), and I love that. It's a skill I developed in the pool to become a walk-on D1 swimmer at Clemson. It led me to take on one of the more rigorous MBA programs and pivot my career from software to marketing. At Central Garden & Pet, I led a rebrand of the largest equity in the company portfolio that opened up new product lines and drove sales 4x faster than the category. None were easy, but I play the long game.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">I listen before I decide.</h3>
                  <p className="disc-trait-text">
                    The DISC describes me as someone who thinks over major decisions before acting and prefers to analyze situations personally before committing. I've seen leaders act like they had all the answers and ignore institutional knowledge. Those are the people who flame out and don't achieve their objectives. My instinct is to gather the data, hear different perspectives, and then make the decision. That gains alignment and is the only way to make positive, lasting, change.
                  </p>
                </div>
                ...
                <div className="disc-trait-card">
                  ...
                  <p className="disc-trait-text">
                    Customer-oriented is my top behavioral hierarchy dimension (63), and Influence is my second highest DISC score (62). Together, this means I'm sociable, trusting, and able to use emotional appeal, which is exactly how I was trained as a CPG / B2B2C marketer at Johnson & Johnson. I can have a real conversation with a clinician, a sales rep, a hospital administrator, and an EVP all in the same day and not have it feel like four different performances.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">My work has always centered on people's lives.</h3>
                  <p className="disc-trait-text">
                    The DISC describes me as patient and empathetic, and I think that shows up in the work I've gravitated toward. At J&J, the marketing mattered because it helped mothers feel confident caring for the people they loved most. At Central Garden and Pet, it was about giving people a backyard worth living in, and making sure the kids playing on those fields were safe doing it. Healthcare staffing sits in that same territory. It's about whether people get access to quality care.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">Once I decide, I'm committed.</h3>
                  <p className="disc-trait-text">
                    The report describes me as tough-minded and unbending after a decision is made. In a VP of Marketing role, that's usually a good thing as you can't run a brand strategy if the direction changes constantly. The flip side is that I can be slow to make a decision in certain situations. To address that, I've learned to consider whether the decision is a 'one-way door' or a 'two-way door.' The former requires more consideration whereas the latter can be reversed relatively easily as new information is available.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">One honest flag from the report.</h3>
                  <p className="disc-trait-text">
                    The areas for improvement section notes I can have trouble establishing priorities when too many things feel equally important. I think that's pretty fair, and I've learned to work closely with my management to align priorities in advance and surface issues that will impact that list. At Central I would develop priorities with the Garden president at the beginning of the year, and worked with him to reprioritize when budget cuts meant that the team would not have the resources to accomplish all original objectives.
                  </p>
                </div>
        ...
        <section className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              ...
              the work to identify issues before they become major headaches. Here's what that looks like across
            ...
            <div className="mb-capabilities-grid">
              ...
              <div className="kinetic-card">
                ...
                <p className="kinetic-card-text">
                  Led a 25-person marketing org spanning 
                  Insights, Digital, Creative, Innovation, and Customer
                  Marketing. Built the Innovaion team from scratch to focus on bigger bets.
                </p>
              </div>
              ...
              <div className="kinetic-card">
                ...
                <p className="kinetic-card-text">
                  Marketing Mix Modeling, attribution, KPI
                  dashboards. 25% efficiency gains through media plan optimization.
                </p>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    Customer Marketing, and Customer Care. Full responsibility for
                    brand development and marketing plans across multi-brand
                    portfolio.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    award-winning campaigns across B2C and professional channels.
                  </p>
                </div>
              </div>
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container" style={{ textAlign: "center" }}>
            ...
            <p className="mb-subtitle" style={{ maxWidth: "540px", margin: "0 auto 2rem" }}>
              Happy to continue the conversation, answer questions, or dig into
