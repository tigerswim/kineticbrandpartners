    ...
    <div className="kinetic-page company-page">
      ...
      <header className="kinetic-header ashley-header" aria-label="Page sections">
        <div className="kinetic-container ashley-header-inner">
          <a href="#top" className="ashley-header-brand" aria-label="Back to top">
      ...
      <main id="top">
          ...
          <div className="kinetic-container">
            ...
            <dl className="mb-capability-list">
              ...
              <div className="mb-capability-row">
                ...
                <dd>
                  Owned the Consumer Insights function at Central Garden &amp; Pet,
                  including research prioritization, vendor management, and synthesis
                  into actionable formats. Insights that shaped Full Season
                  Fertilizer delivered 8.2% brand growth at 4x the category rate.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Cross-Functional Influence</dt>
                <dd>
                  Player-coach style. Built trusted relationships with Merchandising,
                  Design, Creative, Sales, and Legal simultaneously. Navigated
                  matrixed organizations with clarity, driving alignment without
                  always having direct authority.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Claims &amp; Legal Navigation</dt>
                <dd>
                  At Johnson &amp; Johnson, regularly worked with clinical data as the
                  basis for consumer claims. Translated science into motivating
                  language that was accurate, legally defensible, and consumer-tested.
                </dd>
              </div>
              <div className="mb-capability-row">
                ...
                <dd>
                  ...
                  25% efficiency gains through optimization. Built the measurement
                  infrastructure that made marketing&apos;s contribution to business
                  results visible and defensible.
                </dd>
              </div>
            </dl>
          </div>
        ...
        <section id="work" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              From Clio-winning creative to product launches that won major retail
              distribution, here is a selection of work that delivered measurable
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Insight:</strong> Research revealed a clear tension in
                the lawn care category: Millennial homeowners did not understand, and
                did not want to commit to, the traditional 4-step fertilizer program.
                The complexity was a purchase barrier leaving a significant segment
                underserved.
              </p>
              <p className="campaign-description">
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                ...
                had no natural platform to enter the national sports conversation.
                The brand needed to make millions of people suddenly care about
                something they had never thought twice about.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> Partner with NFL star Von Miller on a
                deliberately provocative anti-turf campaign designed to get banned
                by the league. The NFL&apos;s censorship became free media coverage,
            ...
            <div className="campaign-card">
              ...
              <p className="campaign-description">
                ...
                Johnson&apos;s Baby needed to reinforce its emotional equity while
                driving measurable sales results.
              </p>
              <p className="campaign-description">
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    $80MM+ portfolio responsibility. Translated clinical data into
                    consumer claims language. Award-winning campaigns including the
                    J&amp;J Global Burke Award.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    role: technology fluency, complex project delivery, and
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              ...
              mindset I would bring to standing up a new Product Marketing function.
            </p>
            <div className="about-projects-grid">
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  ...
                  data beyond what Strava shows. Taught me relational data design
                  and the discipline of building something people actually use.
                </p>
        ...
        <section id="contact" className="kinetic-section">
          <div className="kinetic-container" style={{ textAlign: "center" }}>
            ...
            >
              If those challenges sound familiar, I would like to talk about what
              building this function together looks like.
            </p>
