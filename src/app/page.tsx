...
export default function Home() {
  return (
    <div className="kinetic-page kbp-main">
      ...
      <main>
        {/* Type-led hero — big display type with atmospheric portrait */}
        <section className="mb-hero">
          <div className="mb-hero-bg" aria-hidden />
          <div className="kinetic-container">
            <div className="mb-hero-content">
              ...
              <HeroHeadline
                className="mb-title"
                lead="Strategic marketing leadership"
                emphasis="that drives growth"
              />
              <p className="mb-subtitle" data-reveal style={{ ['--reveal-delay' as string]: '550ms' }}>
              ...
              <div className="mb-now" data-reveal style={{ ['--reveal-delay' as string]: '700ms' }}>
                Available for VP / CMO conversations. Selectively taking on consulting work. Building side projects with AI.
              </div>
              <div className="mb-cta-group" data-reveal style={{ ['--reveal-delay' as string]: '850ms' }}>
                <CalendlyButton className="kinetic-btn kinetic-btn--primary">
                  Schedule a Meeting <span className="arrow" aria-hidden>→</span>
                </CalendlyButton>
        ...
        {/* Pull-quote intro — text-only, sets the voice */}
        <section className="kbp-intro" data-reveal>
          <div className="kinetic-container">
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left" data-reveal>
              What I Bring
            </h2>
            <dl className="mb-capability-list">
              <div className="mb-capability-row" data-reveal>
              ...
              <div className="mb-capability-row" data-reveal>
                ...
                <dd>
                  ...
                  builds. &ldquo;Best in Class&rdquo; retailer recognition.
                </dd>
              </div>
              <div className="mb-capability-row" data-reveal>
        ...
        <section className="kinetic-section">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left" data-reveal>Where I&apos;ve Worked</h2>
            <div className="mb-experience-grid">
              <div className="mb-exp-card" data-reveal>
                <div className="mb-exp-years">2013 — 2024</div>
              ...
              <div className="mb-exp-card" data-reveal>
                <div className="mb-exp-years">2006 — 2013</div>
                <div className="mb-exp-logo-wrap">
                  <svg
              ...
              <div className="mb-exp-card" data-reveal>
                <div className="mb-exp-years">1999 — 2004</div>
                <div className="mb-exp-logo-wrap">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
        ...
        {/* What I'm Looking For — compressed section padding */}
        <section className="kinetic-section kinetic-section--gray kinetic-section--compact">
          <div className="kinetic-container">
            <div className="mb-looking-for" data-reveal>
