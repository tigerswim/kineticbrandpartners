// KEH Camera Candidate Page
// Live at: kineticbrandpartners.com/keh
// Golden Thread: No Job Too Small
            ...
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                ...
                <h1 className="mb-title animate-slide-up delay-2">
                  A builder who owns the{" "}
                  <span className="kinetic-title-gradient">whole problem</span>
                </h1>
            ...
            <div className="qa-accordion">
              ...
              <details className="qa-item">
                <summary className="qa-question">
                  Businesses that have grown without anyone actually running them
                </summary>
              ...
              <details className="qa-item">
                <summary className="qa-question">
                  The Enterprise and Institutional channel is untapped and unstructured
                </summary>
                <div className="qa-answer">
                  <p>
              ...
              <details className="qa-item">
                <summary className="qa-question">
                  Scaling Repair into a third-party business without breaking what already works
                </summary>
                <div className="qa-answer">
                  <p>
        ...
        <section id="bring" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <dl className="mb-capability-list">
              ...
              <div className="mb-capability-row">
                <dt>Commercial Strategy</dt>
                <dd>
                  Retailer and channel economics, B2B sales cycle management,
                  pricing and margin discipline. $7MM incremental revenue from a
                  single Home Depot pitch built on consumer and retailer data.
                </dd>
              </div>
              <div className="mb-capability-row">
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    role: technology fluency, complex sales cycles, and delivery
                    accountability.
                  </p>
                </div>
              </div>
            ...
            <div className="about-projects-grid">
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  ...
                  wanted a tool that treated it like one.
                </p>
                <div className="about-project-tech">
                  <span>Next.js</span>
                  <span>Supabase</span>
