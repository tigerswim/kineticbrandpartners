...
export default function CalendlyPage() {
  return (
    <div className="kinetic-page company-page">
      ...
      {/* ── STICKY NAV ──────────────────────────────────────────── */}
      <header className="kinetic-header calendly-header" aria-label="Page sections">
        <div className="kinetic-container calendly-header-inner">
          <a href="#top" className="calendly-header-brand" aria-label="Back to top">
            <img src="/calendly/calendly-logo.webp" alt="Calendly" height={28} />
          </a>
          <ul className="calendly-nav">
            ...
            <li><a href="#contact" className="calendly-nav-cta">Let&apos;s Talk</a></li>
          </ul>
        </div>
      </header>
      ...
      <main id="top">
            ...
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                ...
                <h1 className="mb-title animate-slide-up delay-2">
                  ...
                  <span className="kinetic-title-gradient">what comes out the other side</span>
                </h1>

                <p className="mb-subtitle animate-slide-up delay-3">
                  15 years building and optimizing funnels across a Fortune 50 and a Fortune 1000 company,
                  with P&amp;L accountability for the revenue those funnels produced.
                  Making the CPG-to-SaaS move deliberately, because the growth problem is the same in a faster medium.
                </p>
        ...
        <section id="why" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            <div className="kinetic-section-header">
              ...
              <h2 className="kinetic-section-title">The Commercial Problem Is the Same</h2>
            </div>
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              Growth marketing in CPG and SaaS runs on identical mechanics: acquire the right
              customers, activate them fast, keep them engaged, and expand their value over time.
              The medium is faster in SaaS. The discipline is the same. Here is where the work
              maps directly.
            </p>
            ...
            <div className="cpg-saas-grid">
              ...
              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">$20MM+ media budget split across 15+ brands in parallel</div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">Multi-product growth programs with separate KPI profiles</div>
                </div>
              </div>

              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">P&amp;L owner on $80MM+ brand portfolios — defended CAC to a CFO</div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">CAC/LTV accountability, not just channel reporting</div>
                </div>
              </div>

              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">Segmented lifecycle programs reversed multi-year revenue decline on Tucks</div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">Onboarding, engagement, and re-engagement lifecycle in SaaS</div>
                </div>
              </div>

              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">Launched first DTC channel via Shopify; consolidated 6 brand sites, grew sessions 295%</div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">Website as a revenue driver, not a front door</div>
                </div>
              </div>
        ...
        <section id="bring" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              Most growth marketing candidates optimize channels they&apos;ve always known.
              I&apos;ve owned the P&amp;L behind those channels and been accountable for what
              comes out the other side. That&apos;s a different kind of fluency.
            </p>
            <dl className="mb-capability-list">
              <div className="mb-capability-row">
                <dt>P&amp;L Ownership</dt>
                <dd>
                  Managed portfolios from $20MM to $100MM+, full responsibility from gross sales
                  to EBIT. Accountable for revenue, not just activity. Defended CAC to a CFO,
              ...
              <div className="mb-capability-row">
                ...
                <dd>
                  Marketing Mix Modeling, attribution frameworks, real-time KPI dashboards.
                  25% efficiency gains through spend optimization. Built experimentation culture
                  across a multi-brand portfolio with parallel measurement tracks.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Funnel Building &amp; Optimization</dt>
                <dd>
                  Greenfield funnel construction for new product launches and optimization of
                  mature acquisition programs. Grew website sessions 295%, improved first-page
                  SEO 155%, launched the first DTC channel via Shopify.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Lifecycle &amp; Retention</dt>
                <dd>
                  Segmentation, personalized customer journeys, upsell and cross-sell programs.
                  Built engagement infrastructure across 15+ brands. Reversed multi-year revenue
                  declines on the $60MM Tucks brand through targeted digital lifecycle campaigns.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Team Leadership &amp; Scale</dt>
                <dd>
                  Built and led a 25-person marketing organization spanning Consumer Insights,
                  Digital, Creative, Innovation, and Customer Marketing. Player-coach style.
                  Agency selection, vendor management, cross-functional alignment.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Tech-Forward Operator</dt>
                <dd>
                  5 years implementing enterprise B2B software at Manhattan Associates before
                  ever leading a marketing team. Active AI builder: personal CRM, marketing
                  automations (Zapier, n8n), multiple web apps. Served on enterprise AI
                  Governance Team.
                </dd>
              </div>
            </dl>
        ...
        <section id="work" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              From Clio-winning campaigns to product launches that won Walmart and Home Depot
              distribution, here is a selection of work that moved brand metrics and bottom-line
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                ...
                Artificial turf was causing a surge in player injuries, and Pennington had no
                natural platform to enter the national sports conversation.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> Partner with NFL star Von Miller on a deliberately
                provocative anti-turf campaign designed to get banned by the league. The
                NFL&apos;s censorship became free media coverage, sparking a grassroots movement
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Insight:</strong> Millennial homeowners did not understand, and did
                not want to commit to, the traditional 4-step fertilizer program. The complexity
              ...
              <p className="campaign-description">
                ...
                eliminated multi-step complexity. Led the cross-functional development and
                go-to-market strategy, built the business case for Walmart, and won distribution.
                Walmart&apos;s own sales data confirmed Full Season indexed higher with Millennial
                shoppers than the competition.
              </p>
            ...
            <div className="campaign-card">
              ...
              <p className="campaign-description">
                ...
                Johnson&apos;s Baby needed to reinforce its emotional equity while driving
                measurable sales results.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> An Olympic campaign where athletes thanked their
                mothers on the world stage. The campaign was so compelling that Debbie Phelps,
                Michael Phelps&apos; mom, <em>asked</em> to participate. Won J&amp;J&apos;s
                Global Burke Award.
              </p>
            ...
            <div className="mb-experience-grid">
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Led marketing for the $1.5B Garden segment across a 15+ brand portfolio.
                    Managed a 25-person organization spanning Insights, Innovation, Digital,
                    Creative, Customer Marketing, and Customer Care. Full P&amp;L accountability
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Consumer and Medical Device divisions. Multiple brands with $80MM+ portfolio
                    responsibility. P&amp;L owner on Baby Oil, Baby Powder, and Tucks.
                    Award-winning campaigns including the J&amp;J Global Burke Award.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    Michelin, BIC, and DeBeers. Built the operational and technology foundation
                    that preceded every marketing leadership role.
                  </p>
                </div>
              </div>
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              When I want to understand something, I build it. These are three tools I shipped
              from scratch using AI-assisted development. One of them is literally a SaaS metrics
              dashboard.
            </p>
            <div className="about-projects-grid">
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  A dashboard for modeling SaaS KPIs and seeing how they respond to different
                  assumptions. Built to understand the financial mechanics of subscription
                  businesses from the inside. Role-based views surface what actually matters.
                </p>
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  A CRM-style tool I built to track every contact and connection in one place.
                  Job hunting is a sales process; I wanted a tool that treated it like one.
                  Automated daily briefings via n8n.
                </p>
                <div className="about-project-tech">
                  <span>Next.js</span>
                  <span>Supabase</span>
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  ...
                  what Strava shows. Taught me relational data design and the discipline of
        ...
        <section id="contact" className="kinetic-section">
          <div className="kinetic-container" style={{ textAlign: "center" }}>
            ...
            <p className="mb-subtitle" style={{ maxWidth: "540px", margin: "0 auto 2rem" }}>
              If those three problems sound like the ones keeping you up at night, let&apos;s
              talk about what working on them together looks like.
            </p>
            <div className="mb-cta-group calendly-cta-group" style={{ justifyContent: "center" }}>
              <CalendlyButton className="kinetic-btn kinetic-btn--primary">
                Schedule 30 Min
              </CalendlyButton>
              <a
