// Calendly Candidate Page
// Live at: kineticbrandpartners.com/calendly
// Golden Thread: Curiosity-Driven Learner
// Primary: #006BFF (Calendly Blue) | Secondary: #004796 (Congress Blue) | Accent: #0AE8F0 (Turquoise)
...
export const metadata = {
  title: "Calendly | Dan Hoeller",
  description:
    "Growth marketing leader with P&L ownership across $80MM+ portfolios, making a deliberate move into SaaS. Candidate for Senior Director, Growth Marketing.",
  icons: {
    icon: "/calendly/calendly-favicon.png",
  },
};
...
export default function CalendlyPage() {
  return (
    <div className="kinetic-page company-page">
      ...
      {/* ── STICKY NAV ──────────────────────────────────────────── */}
      <header
        className="kinetic-header calendly-header"
        aria-label="Page sections"
      >
        <div className="kinetic-container calendly-header-inner">
          <a
            href="#top"
            className="calendly-header-brand"
            aria-label="Back to top"
          >
            <img
              src="/calendly/calendly-logo.webp"
              alt="Calendly"
              height={28}
            />
          </a>
          ...
          <ul className="calendly-nav">
            ...
            <li>
              <a href="#contact" className="calendly-nav-cta">
                Let&apos;s Talk
              </a>
            </li>
          </ul>
      ...
      <main id="top">
            ...
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                ...
                >
                  ...
                  Sr. Director, Growth Marketing Candidate &middot; Atlanta, GA
                </div>

                <h1 className="mb-title animate-slide-up delay-2">
                  A growth marketer who owns{" "}
                ...
                <p className="mb-subtitle animate-slide-up delay-3">
                  15 years building and optimizing funnels across Fortune 50 and
                  Fortune 1000 companies, with P&amp;L accountability for the
                  revenue those funnels produced. Making the CPG-to-SaaS move
                  deliberately, as I want to drive growth in an environment
                  using my marketing and software skills.
                </p>

                <div className="mb-cta-group calendly-cta-group animate-slide-up delay-4">
        ...
        {/* ── SECTION 2: CPG-TO-SAAS PROOF ─────────────────────── */}
        <section id="why" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            <div className="kinetic-section-header">
              <span className="kinetic-section-badge">The Move</span>
              <h2 className="kinetic-section-title">
                The Commercial Challenge Is the Same
              </h2>
            </div>
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              Growth marketing in CPG and SaaS runs on the same principles:
              acquire the right customers, activate them fast, keep them
              engaged, and expand their value over time. Here is where the work
              maps directly.
            </p>

            <div className="cpg-saas-grid">
              <div className="cpg-saas-card">
                <div className="cpg-saas-label cpg-saas-label--left">CPG</div>
                <div className="cpg-saas-connector">
                  <span className="cpg-saas-arrow">&rarr;</span>
                </div>
                <div className="cpg-saas-label cpg-saas-label--right">SaaS</div>
              </div>

              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">
                    $20MM+ media budget split across 15+ brands in parallel
                  </div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">
                    Multi-product growth programs with separate KPI profiles
                  </div>
                </div>
              </div>
              ...
              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">
                    P&amp;L owner on $80MM+ brand portfolios who has defended
                    marketing spend to CFOs
                  </div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">
                    CAC/LTV accountability, not just channel reporting
                  </div>
                </div>
              </div>
              ...
              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">
                    Designed multi-stage customer journeys by segment: acquisition
                    channel, use case, and purchase cycle for a $250MM brand
                  </div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">
                    Onboarding, engagement, and re-engagement lifecycle in SaaS
                  </div>
                </div>
              </div>
              ...
              <div className="cpg-saas-row">
                <div className="cpg-saas-cell cpg-saas-cell--cpg">
                  <div className="cpg-saas-proof">
                    Launched first DTC channel via Shopify; consolidated 6 brand
                    sites, grew sessions 295%
                  </div>
                </div>
                <div className="cpg-saas-arrow-col">&rarr;</div>
                <div className="cpg-saas-cell cpg-saas-cell--saas">
                  <div className="cpg-saas-concept">
                    Website as a revenue driver, not a front door
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="bring" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              Most growth marketing candidates optimize channels they&apos;ve
              always known. I&apos;ve owned the P&amp;L behind those channels
              and been accountable for what comes out the other side.
              That&apos;s a different kind of fluency.
            </p>
            <dl className="mb-capability-list">
              <div className="mb-capability-row">
                ...
                <dd>
                  ...
                  from gross sales to EBIT. Accountable for revenue, not just
                  activity. Defended CAC to a CFO, not just reported it.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Data-Driven Growth</dt>
                <dd>
                  Marketing Mix Modeling, attribution frameworks, real-time KPI
                  dashboards. 25% efficiency gains through spend optimization.
                  Built experimentation culture across a multi-brand portfolio
                  with parallel measurement tracks.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Funnel Building &amp; Optimization</dt>
                <dd>
                  Greenfield funnel construction for new product launches and
                  optimization of mature acquisition programs. Grew website
                  sessions 295%, improved first-page SEO 155%, launched the
                  first DTC channel via Shopify.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Lifecycle &amp; Retention</dt>
                <dd>
                  Segmentation, personalized customer journeys, upsell and
                  cross-sell programs. Built engagement infrastructure across
                  15+ brands. Reversed multi-year revenue declines on the $60MM
                  Tucks brand through targeted digital lifecycle campaigns.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Team Leadership &amp; Scale</dt>
                <dd>
                  Built and led a 25-person marketing organization spanning
                  Consumer Insights, Digital, Creative, Innovation, and Customer
                  Marketing. Player-coach style. Agency selection, vendor
                  management, cross-functional alignment.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Tech-Forward Operator</dt>
                <dd>
                  5 years implementing enterprise B2B software at Manhattan
                  Associates before ever leading a marketing team. Active AI
                  builder: personal CRM, marketing automations (Zapier, n8n),
                  multiple web apps. Served on enterprise AI Governance Team.
                </dd>
              </div>
            </dl>
          </div>
        ...
        <section id="work" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              From Clio-winning campaigns to product launches that won Walmart
              and Home Depot distribution, here is a selection of work that
              moved brand metrics and bottom-line results at the same time.
            </p>
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                ...
                purchase. Artificial turf was causing a surge in player
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              <div className="campaign-header">
                ...
                <p className="campaign-meta">
                  Central Garden &amp; Pet &middot; Product Innovation &amp; GTM
                </p>
              </div>
              <p className="campaign-description">
                <strong>The Insight:</strong> Millennial homeowners did not
                understand, and did not want to commit to, the traditional
                4-step fertilizer program. The complexity was a purchase
                barrier, leaving a significant segment underserved.
              </p>
              <p className="campaign-description">
                ...
                complexity. Led the cross-functional development and
                go-to-market strategy, built the business case for Walmart, and
                won distribution. Walmart&apos;s own sales data confirmed Full
            ...
            <div className="campaign-card">
              ...
              <div className="campaign-media-grid campaign-media-grid--2col">
                <div className="media-item">
                  ...
                  <div className="calendly-video-wrapper">
                    <video
                      controls
            ...
            <div className="mb-experience-grid">
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Led marketing for the $1.5B Garden segment across a 15+
                    brand portfolio. Managed a 25-person organization spanning
                    Insights, Innovation, Digital, Creative, Customer Marketing,
                    and Customer Care. Full P&amp;L accountability from gross
                    sales to EBIT.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-role">
                    Brand Management &middot; 7 years
                  </p>
                  <p className="mb-exp-desc">
                    Consumer and Medical Device divisions. Multiple brands with
                    $80MM+ portfolio responsibility. P&amp;L owner on Baby Oil,
                    Baby Powder, and Tucks. Award-winning campaigns including
                    the J&amp;J Global Burke Award.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-role">
                    Enterprise Tech &middot; 5 years
                  </p>
                  <p className="mb-exp-desc">
                    Supply chain software implementations for Fortune 500
                    clients including Michelin, BIC, and DeBeers. Built the
                    operational and technology foundation that preceded every
            ...
            <div className="mb-education-row" style={{ marginTop: "2.5rem" }}>
              ...
              <div className="mb-edu-card">
                ...
                <p className="mb-edu-text">
                  ...
                  Clemson University &middot; Walk-on swimmer, 4-year letterman,
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              ...
              tools I shipped from scratch using AI-assisted development. One of
              them is literally a SaaS metrics dashboard.
            </p>
            <div className="about-projects-grid">
              <div className="kinetic-card">
                <div className="calendly-project-icon">
                  <img
                    src="/side-projects/saas-favicon.svg"
                ...
                <p className="about-project-desc">
                  ...
                  to different assumptions. Built to understand the financial
                  mechanics of subscription businesses from the inside.
                  Role-based views surface what actually matters.
                </p>
              ...
              <div className="kinetic-card">
                <div className="calendly-project-icon">
                  <img
                    src="/side-projects/job-tracker-favicon.png"
                    alt="Job Tracker"
                    width={32}
                    height={32}
                  />
                ...
                <p className="about-project-desc">
                  A CRM-style tool I built to track every contact and connection
                  in one place. Job hunting is a sales process; I wanted a tool
                  that treated it like one. Automated daily briefings via n8n.
                </p>
                <div className="about-project-tech">
                  <span>Next.js</span>
                  <span>Supabase</span>
              ...
              <div className="kinetic-card">
                <div className="calendly-project-icon">
                  <img
                    src="/side-projects/raceprep-favicon.png"
                    alt="RacePrep"
                    width={32}
                    height={32}
                  />
        ...
        <section id="contact" className="kinetic-section">
          <div className="kinetic-container" style={{ textAlign: "center" }}>
            ...
            >
              If those three problems sound like the ones keeping you up at
              night, let&apos;s talk about what working on them together looks
              like.
            </p>
            <div
              className="mb-cta-group calendly-cta-group"
              style={{ justifyContent: "center" }}
            >
              <CalendlyButton className="kinetic-btn kinetic-btn--primary">
                Schedule 30 Min
