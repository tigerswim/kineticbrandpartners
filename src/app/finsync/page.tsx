// FINSYNC Candidate Page
// Live at: kineticbrandpartners.com/finsync
// Golden Thread: Brand-to-Business Translator
// Brand: Primary #1A2E5C (navy), Secondary #009EC3 (teal), Font: Inter
...
export const metadata = {
  title: "FINSYNC | Dan Hoeller",
  description:
    "Dan Hoeller — VP Marketing candidate for FINSYNC. 15 years building brands and growth programs that translate directly to revenue.",
};

export default function FinsyncPage() {
  return (
              ...
              <div className="ftt-two-col">
                <div className="ftt-text">
                  <p className="campaign-description">
                    ...
                    4-step fertilizer program promoted by the category leader.
                    Complexity was the barrier to purchase and adoption.
                  </p>
                  <p className="campaign-description">
                    <strong>The Approach:</strong> Used consumer insight to
                    define a genuinely differentiated product: Full Season, one
                    application per season. Led cross-functional development,
                    built the business case, and won Walmart distribution.
                    Walmart's own data showed Full Season indexed higher with
                    Millennial shoppers than the competition.
                  </p>
                </div>
              ...
              <div className="ftt-two-col">
                <div className="ftt-text">
                  <p className="campaign-description">
                    ...
                    equity and grow the business against private label and
                    challenger brands across a $400MM portfolio.
                  </p>
                  <p className="campaign-description">
                    <strong>The Approach:</strong> An Olympic campaign where
                    athletes thanked their mothers on the world stage. It worked
                    well enough that Debbie Phelps, Michael Phelps' mom, asked
                    to be in it. The portfolio ran with full P&amp;L
                    accountability from Gross Sales to EBIT.
                  </p>
                </div>
            ...
            <div className="mb-experience-grid">
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    Customer Care. Built the Innovation function from scratch.
                    Full responsibility for brand strategy, demand gen, and
                    media allocation across a multi-brand portfolio.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Consumer and Medical Device divisions. P&amp;L ownership on
                    Tucks ($60MM) and Baby Oil/Powder (~$80MM). Reversed
                    multi-year revenue declines through targeted digital
                    campaigns. Led full GTM for J&amp;J Ortho Diagnostics
                    including partner-channel and end-user marketing
                    simultaneously.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    clients. I learned how businesses actually work before I
                    ever touched a marketing brief. That foundation shows up in
                    how I think about commercial decisions.
                  </p>
                </div>
              </div>
            </div>
