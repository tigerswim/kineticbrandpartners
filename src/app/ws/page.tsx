// Wayne-Sanderson Farms Candidate Page
// Live at: kineticbrandpartners.com/ws
// Golden Thread: Brand-to-Business Translator
// Colors: Primary #CE2027, Secondary #1A1A1A, Accent #8B6F3E
...
export const metadata = {
  title: "Wayne-Sanderson Farms | Dan Hoeller",
  description:
    "Dan Hoeller - VP Marketing candidate for Wayne-Sanderson Farms. A brand-to-business translator with 15 years turning marketing investment into commercial results.",
  icons: {
    icon: "/ws/ws-favicon.png",
  },
};

export default function WayneSandersonPage() {
  return (
    <div className="kinetic-page wsf-page">
      <GradientMesh />

      <header className="kinetic-header wsf-header" aria-label="Page sections">
        <div className="kinetic-container">
          <a href="#top" className="wsf-header-brand" aria-label="Back to top">
            <img src="/ws/wsf-logo.png" alt="Wayne-Sanderson Farms" height={32} />
          </a>

          <ul className="kinetic-nav wsf-nav">
      ...
      <main id="top">
          ...
          <div className="kinetic-container">
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                <div className="wsf-hero-logo animate-slide-up delay-1">
                  <img src="/ws/wsf-logo.png" alt="Wayne-Sanderson Farms" />
                </div>

                <div className="kinetic-badge animate-slide-up delay-1" style={{ marginBottom: "1.25rem" }}>
                  <span className="kinetic-badge-dot"></span>
                  VP Marketing Candidate &middot; Atlanta, GA
                </div>

                <h1 className="mb-title animate-slide-up delay-2">
                  A brand-to-business translator who turns{" "}
                  <span className="kinetic-title-gradient">marketing into margin</span>
                </h1>
                ...
                <div className="mb-cta-group animate-slide-up delay-4">
                  ...
                  <div className="mb-cta-links">
                    <a href="mailto:danhoeller@gmail.com" className="mb-cta-link">Send an Email</a>
                    <span className="mb-cta-divider">&middot;</span>
                    <a href="https://linkedin.com/in/danhoeller" target="_blank" rel="noopener noreferrer" className="mb-cta-link">LinkedIn</a>
                  </div>
                </div>
              </div>
          ...
          <div className="kinetic-container">
            ...
            <dl className="mb-capability-list">
              <div className="mb-capability-row">
                ...
                <dd>
                  Inherited a 25-person marketing organization at Central Garden &amp; Pet
                  spanning Insights, Digital, Creative, Innovation, Customer Marketing, and
                  Customer Care. Unified it, built the Innovation function from scratch,
                  and ran it through several CEO transitions.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Brand Portfolio Management</dt>
                <dd>
                  At Central Garden &amp; Pet, concentrated investment behind Pennington
                  grew the brand 4x the category. The rest of the portfolio got maintenance
                  funding or promo dollars, depending on where each brand could actually earn
                  a return.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Data-Driven and P&amp;L-Informed Marketing</dt>
                <dd>
                  Marketing Mix Modeling, attribution, KPI dashboards at Central. 25%
                  efficiency gains through media plan optimization. Built for categories
                  with seasonal and input-cost volatility.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Retail Partnership</dt>
                <dd>
                  Unlocked $7MM in incremental revenue at The Home Depot using consumer
                  insight as a business case, not just a deck. Circana fluency, planogram
                  strategy, and promotional ROI.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Creative Excellence</dt>
                <dd>
                  Two Clio Sports Awards for #FlipTheTurf. 3.95B impressions, 10-point
                  brand awareness lift. Strategy-grounded creative that drove distribution
                  wins.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Supply-Chain Grounding</dt>
                <dd>
                  Started at Manhattan Associates implementing warehouse management
                  systems for Michelin and BIC. Understands how product moves, how
                  operational constraints shape commercial calendars, and why most
                  marketing plans fall apart between the whiteboard and the plant.
                </dd>
              </div>
            </dl>
          </div>
        ...
        <section id="work" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              From Clio-winning creative to data-driven product innovation, a selection
              of marketing work that delivered measurable commercial impact and cultural
              resonance.
            </p>
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Challenge:</strong> Grass seed is the ultimate low-involvement
                purchase. Yet artificial turf was causing a surge in player injuries, and
                Pennington had no natural platform to enter the national sports
                conversation. The brand needed to make millions of people suddenly care
                about something they had never thought twice about.
              </p>
              <p className="campaign-description">
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              <div className="campaign-header">
                ...
                <p className="campaign-meta">Central Garden &amp; Pet &middot; Product Innovation</p>
              </div>
              <p className="campaign-description">
                <strong>The Insight:</strong> Millennial homeowners did not understand, and
                did not want to commit to, the traditional 4-step fertilizer program
                promoted by the category leader. Complexity was a barrier, leaving a
                significant segment underserved.
              </p>
              <p className="campaign-description">
                ...
                fertilizer. Led cross-functional development and go-to-market strategy,
                built the business case for Walmart, and won distribution. Walmart's own
                data confirmed the insight.
              </p>
              <div className="campaign-media-grid campaign-media-grid--2col">
                <div className="media-item">
            ...
            <div className="campaign-card">
              ...
              <p className="campaign-description">
                <strong>The Approach:</strong> Two paths. Drive reach and relevance with
                "Thanks, Mom," an Olympic campaign where athletes thanked their mothers
                on the world stage, so compelling that Debbie Phelps, Michael Phelps'
                mom, asked to participate. And reinforce the brand's deep equity through
                emotional print campaigns and digital activations outside the Olympics.
              </p>
              <div className="campaign-media-grid campaign-media-grid--3col">
                ...
                <div className="media-item">
                  ...
                  <div className="media-wrapper">
                    <img src="/images/Pink-lotion.jpg" alt="Johnson's Baby Pink Lotion Campaign" width={510} height={661} className="media-image" loading="lazy" decoding="async" />
                  </div>
                </div>
              </div>
              <div className="campaign-results">
            ...
            <div className="mb-experience-grid">
              ...
              <div className="mb-exp-card">
                <div className="mb-exp-logo-wrap">
                  <svg viewBox="0 0 453.29 164.44" width={160} height={58} aria-label="Central Garden &amp; Pet" role="img">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Led marketing for the $1.5B Garden segment. Unified a 25-person team
                    across Insights, Innovation, Digital, Creative, Customer Marketing,
                    and Customer Care. Grew Pennington at 4x the category rate and
                    unlocked $7MM in incremental Home Depot revenue through a consumer
                    insight-led business case.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Consumer and Medical Device divisions. Managed an $80MM+ Baby Care
                    portfolio and turned around the $60MM Tucks brand (+26.8% growth).
                    Built consumer insights processes, new product development
                    frameworks, and the Clio-nominated "Thanks, Mom" campaign.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                <div className="mb-exp-logo-wrap">
                  <img src="/logos/manhattan-associates-sm.webp" alt="Manhattan Associates" width={140} height={35} loading="lazy" decoding="async" />
                </div>
                <div className="mb-exp-content">
                  <h3>Manhattan Associates</h3>
                  <p className="mb-exp-role">Enterprise Tech &middot; 5 years</p>
                  <p className="mb-exp-desc">
                    Warehouse management system implementations for Fortune 500 clients
                    including Michelin and BIC. Built foundation in supply chain
                    operations, complex B2B sales cycles, and operational excellence
                    before transitioning to marketing.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="contact" className="kinetic-section">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left">Ready When You Are</h2>
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              Let's keep the conversation going and talk about what's next.
            </p>
            <div style={{ display: "flex", flexDirection: "row", gap: "1rem", flexWrap: "wrap" }}>
              <CalendlyButton className="kinetic-btn kinetic-btn--primary">Schedule 30 Min</CalendlyButton>
              <a href="mailto:danhoeller@gmail.com" className="kinetic-btn kinetic-btn--secondary">Send an Email</a>
            </div>
          </div>
        </section>
      </main>
