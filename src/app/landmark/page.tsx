// Landmark Properties Candidate Page
// Live at: kineticbrandpartners.com/landmark
// Golden Thread: Player-Coach Builder
// Primary: #062a49 (Landmark navy) | Secondary: #638092 (Landmark steel blue)
...
export const metadata = {
  title: "Landmark Properties | Dan Hoeller",
  description:
    "Marketing executive with 15 years building multi-brand portfolios and leading high-performing teams — built to help Landmark centralize and scale its marketing organization.",
  icons: {
    icon: "/landmark/landmark-favicon.png",
  },
};
...
export default function LandmarkPage() {
  return (
    <div className="kinetic-page company-page">
      ...
      {/* ── STICKY NAV ──────────────────────────────────────────── */}
      <header className="kinetic-header landmark-header" aria-label="Page sections">
        <div className="kinetic-container landmark-header-inner">
          <a href="#top" className="landmark-header-brand" aria-label="Back to top">
            <img src="/landmark/landmark-logo-white.svg" alt="Landmark Properties" height={28} />
          </a>
          <ul className="landmark-nav">
            <li><a href="#why">Three Problems</a></li>
            <li><a href="#bring">What I Bring</a></li>
            <li><a href="#work">Selected Work</a></li>
            <li><a href="#background">Background</a></li>
            <li><a href="#contact" className="landmark-nav-cta">Let&apos;s Talk</a></li>
          </ul>
        </div>
      </header>
      ...
      <main id="top">
            ...
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                ...
                <div style={{ marginBottom: "1.5rem" }} className="animate-slide-up delay-1">
                  <img
                    src="/landmark/landmark-logo-grey.png"
                ...
                <div className="kinetic-badge animate-slide-up delay-1" style={{ marginBottom: "1.25rem" }}>
                  ...
                  SVP Marketing &amp; Brand Strategy Candidate &middot; Atlanta, GA
                </div>

                <h1 className="mb-title animate-slide-up delay-2">
                  Building the team that{" "}
                  <span className="kinetic-title-gradient">builds the brand</span>
                </h1>

                <p className="mb-subtitle animate-slide-up delay-3">
                  15 years building and leading marketing organizations from the inside out.
                  Took 6 siloed functions and turned them into one integrated team. Managed
                  a 9-brand portfolio for a $1.5B business, built the measurement infrastructure, 
                  and ran award-winning creative that moved both brand health and
                  the top line. The Landmark opportunity is exactly the kind of org-building
                  challenge I do best.
                </p>
        ...
        <section id="why" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              Landmark is building something real: a centralized, in-house marketing organization
              that can serve a growing portfolio with brand consistency and operational rigor.
              Here is how I think about the three biggest challenges in getting there.
            </p>
            ...
            <div className="qa-accordion">
              ...
              <details className="qa-item">
                <summary className="qa-question">
                  A house of brands without shared governance
                </summary>
                <div className="qa-answer">
                  <p>
                    My approach: start with a brand architecture audit before building
                    anything new. Which brands are genuinely distinct, which are differentiated
                    in name only, and what preferences do residents have? Then build
                    governance that field teams will actually use. Not a brand bible that gets
                    ignored, but a toolkit with clear decision rights and a shared creative
                    services team they can pull from without reinventing from scratch.
                  </p>
                  <p>
                    At Central Garden &amp; Pet, I managed 9 brands across a $1.5B segment
                    and built the shared governance that let each brand feel distinct while
                    keeping the portfolio coherent. That is the same problem Landmark is
                    describing at the property level.
                  </p>
                </div>
              </details>
              ...
              <details className="qa-item">
                <summary className="qa-question">
                  No measurement infrastructure to show marketing is working
                </summary>
                <div className="qa-answer">
                  <p>
                    My approach: align on objectives and then build the measurement layer before anything
                    else. Define the 4-5 metrics that actually predict lease performance
                    (pre-lease velocity, cost-per-lease, brand awareness, and retention
                    signals), then build dashboards that anyone can check without a
                    marketing degree.
                  </p>
                  <p>
                    I built Marketing Mix Modeling and KPI dashboards at Central
                    Garden &amp; Pet, improving marketing efficiency 25% by optimizing the media mix
                    and making spend allocation visible and defensible.
                  </p>
                </div>
              </details>
              ...
              <details className="qa-item">
                <summary className="qa-question">
                  Earning the trust of property, development, and construction teams
                </summary>
                <div className="qa-answer">
                  <p>
                    My approach: earn that trust through questions, not presentations. The
                    first 90 days should include time on the operations side, learning how a
                    property gets built, when marketing should be in the room during a new
                    community launch, and what field teams actually need to close leases.
                    Then make marketing useful to them, not just visible.
                  </p>
                  <p>
                    I spent 5 years implementing supply chain software for Fortune 500
                    manufacturers at Manhattan Associates before I ever ran a marketing
                    team. I know what it looks like from inside the operational machine,
                    and that foundation is what makes cross-functional partnership real
        ...
        <section id="bring" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              This role will need someone who can set the strategy and still give
              meaningful creative feedback on a Monday morning. I am wired that
              way. As a player-coach, I don&apos;t ask my teams to navigate territory I haven&apos;t worked through myself.
            </p>
            <dl className="mb-capability-list">
              <div className="mb-capability-row">
                <dt>Brand Architecture &amp; Portfolio Management</dt>
                <dd>
                  Managed a 9-brand portfolio for a $1.5B business. Built the governance,
                  investment allocation framework, and brand health tracking that kept each
                  brand distinct while the portfolio grew coherently.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Team Building &amp; Organizational Design</dt>
                <dd>
                  Player-coach who unified and led a 25-person marketing organization spanning
                  Insights, Innovation, Digital, Creative, Customer Marketing, and Customer
                  Care. Integrated 6 siloed functions into one org with shared governance
                  and unified planning.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Measurement Infrastructure</dt>
                <dd>
                  Marketing Mix Modeling, attribution frameworks, KPI dashboards.
                  Built the measurement layer that led to 25% efficiency
                  gains through optimization.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Creative Excellence &amp; Campaign Leadership</dt>
                <dd>
                  Clio Award-winning campaigns. 3.95B earned media impressions. J&amp;J Global
                  Burke Award. Strategy-grounded creative that moves brand health and drives
                  measurable business results at the same time.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Digital &amp; MarTech Implementation</dt>
                <dd>
                  MarTech stack builds, product content infrastructure (Salsify, Vizit),
                  DTC channel launch via Shopify, e-commerce content earning retailer
                  &ldquo;Best in Class&rdquo; recognition. Technology as a tool for the team, not
                  a distraction.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Cross-Functional &amp; Operational Credibility</dt>
                <dd>
                  Started in Fortune 500 supply chain software consulting. Five years
                  implementing enterprise systems before running marketing gave me the
                  operational foundation to partner credibly with cross-functional teams.
                </dd>
              </div>
            </dl>
          </div>
        ...
        <section id="work" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              Award-winning creative, data-driven product launches, and campaigns that
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Challenge:</strong> Grass seed is a low-involvement purchase.
                Artificial turf was causing a surge in player injuries, and Pennington had
                no natural platform to enter the national sports conversation. The brand
                needed to make millions of people suddenly care about something they&apos;d
                never thought twice about.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> Partner with NFL star Von Miller on a
                deliberately provocative anti-turf campaign designed to get banned by the
                league. The NFL&apos;s censorship became free media coverage, sparking a
                grassroots movement among players and fans.
              </p>

              <div className="campaign-media-grid campaign-media-grid--2col">
                <div className="media-item">
                  <h3 className="media-item-title">Banned Ad</h3>
                  <div className="landmark-video-wrapper">
                    <video
                      controls
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Insight:</strong> Millennial homeowners did not want to commit
                to a four-step seasonal fertilizer program. The complexity was a purchase
              ...
              <p className="campaign-description">
                ...
                fertilizer that eliminated multi-step complexity entirely. Led the
                cross-functional development and go-to-market strategy, built the business
                case for Walmart, and won distribution. Walmart&apos;s own sales data confirmed
                Full Season indexed higher with Millennial shoppers than the competition.
              </p>
              ...
              <div className="campaign-results">
                ...
                <div className="results-grid">
                  ...
                  <div className="result-stat">
                    ...
                    <div className="result-stat-label">Incremental Revenue, Home Depot</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="campaign-card">
              ...
              <p className="campaign-description">
                <strong>The Challenge:</strong> In a commoditized baby care aisle, Johnson&apos;s
                Baby needed to reinforce its emotional equity while driving measurable sales results.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> An Olympic campaign where athletes thanked
                their mothers on the world stage. The campaign was so compelling that Debbie
                Phelps, Michael Phelps&apos; mom, <em>asked</em> to participate. Won J&amp;J&apos;s
                Global Burke Award.
              </p>
            ...
            <div className="mb-experience-grid">
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Led marketing for the $1.5B Garden segment. Integrated and managed a
                    25-person organization spanning 6 functions. Built brand governance,
                    KPI infrastructure, and creative capabilities for a 9-brand portfolio.
                    Member of the Central Leadership Council and AI Governance Team.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    responsibility. P&amp;L turnarounds, innovation pipelines, and award-winning
                    campaigns including the J&amp;J Global Burke Award.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Supply chain software implementations for Fortune 500 clients including
                    Michelin, BIC, and DeBeers. Built the operational foundation that preceded
                    every leadership role: technology fluency, delivery accountability, and
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              When I want to understand something, I build it. These are three tools I
              shipped from scratch using AI-assisted development to solve problems I
              actually had.
            </p>
            <div className="about-projects-grid">

              <div className="kinetic-card">
                <div className="landmark-project-icon">
                ...
                <p className="about-project-desc">
                  A triathlon training app built to surface swim, bike, and run data beyond
                  what Strava shows. Taught me relational data design and building for
                  actual use.
                </p>
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  A CRM-style job search tool that tracks every contact and connection in
                  one place. Job hunting is a sales process; I built a tool that treats it
                  like one.
                </p>
                <div className="about-project-tech">
                  <span>Next.js</span>
              ...
              <div className="kinetic-card">
                ...
                <p className="about-project-desc">
                  A dashboard for modeling SaaS KPIs and seeing how they respond to
                  different assumptions. Built to understand the financial mechanics of
                  subscription businesses from the inside.
                </p>
                <div className="about-project-tech">
                  <span>Next.js</span>
                  <span>TypeScript</span>
        ...
        <section id="contact" className="kinetic-section">
          <div className="kinetic-container" style={{ textAlign: "center" }}>
            ...
            >
              If those problems sound like the right kind of challenge, I&apos;d like
              to talk about what working on them together looks like.
            </p>
