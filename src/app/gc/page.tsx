// GameChanger Candidate Page
// Live at: kineticbrandpartners.com/gc
// Golden thread: Player-Coach Builder
// Colors: #07081b (dark indigo), #00f092 (bright green), #006554 (GC teal)
// Font: aktiv-grotesk
...
export const metadata = {
  title: "GameChanger | Dan Hoeller",
  description:
    "VP Brand Marketing candidate for GameChanger. 15 years building consumer brands from Fortune 50 to growth-stage companies.",
  icons: {
    icon: "/gc/gc-favicon.png",
  },
};
...
export default function GCPage() {
  return (
    <div className="kinetic-page company-page">
      ...
      <header className="kinetic-header gc-header" aria-label="Page sections">
        <div className="kinetic-container">
          <a href="#top" className="gc-header-brand" aria-label="Back to top">
            <img src="/gc/GameChanger_Logo_Logo.png" alt="GameChanger" height={32} />
          </a>
          <ul className="kinetic-nav gc-nav">
            <li><a href="#why">Why GC</a></li>
      ...
      <main id="top">
          ...
          <div className="kinetic-container">
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                ...
                <div style={{ marginBottom: "1.75rem" }} className="animate-slide-up delay-1">
                  <img
                    src="/gc/GC-logo-white.2.png"
                    alt="GameChanger"
                    height={156}
                    style={{ display: "block", objectFit: "contain", maxWidth: "470px" }}
                  />
                </div>

                <div className="kinetic-badge animate-slide-up delay-1" style={{ marginBottom: "1.25rem" }}>
                  <span className="kinetic-badge-dot"></span>
                  VP Brand Marketing Candidate · Atlanta, GA
                </div>
                <h1 className="mb-title animate-slide-up delay-2">
                  Building brands that earn their place in culture
                </h1>
                <p className="mb-subtitle animate-slide-up delay-3">
                  15 years building consumer brands from Fortune 50 to Fortune 1000 companies.
                  The work that matters most starts with a genuine human insight, earns attention,
        ...
        {/* =====================================================================
            SECTION 2: WHY GC / Q&A
            ===================================================================== */}
        <section id="why" className="gc-qa-section">
          <div className="kinetic-container">
            <div className="gc-qa-header">
              <span className="gc-qa-badge">The Conversation</span>
              <h2 className="gc-qa-title">Why GameChanger</h2>
              <p className="gc-qa-intro">
                GameChanger already has something most brands spend years trying to manufacture: a real place in people&apos;s lives.
                The opportunity to build on that, and do it with a modern, social-first approach, is the exact kind of work I love to do.
              </p>
            </div>

            <div className="gc-qa-accordion">

              <details className="gc-qa-item">
                <summary className="gc-qa-question">
                  <span>Why do you want to work at GameChanger?</span>
                  <span className="gc-qa-chevron">▾</span>
                </summary>
                <div className="gc-qa-answer">
                  <p>
                    I&apos;ve been an athlete my whole life: collegiate swimmer, Ironman finisher, cyclist.
                    Sports have given me a lot. But I never truly appreciated the parent emotional
                    commitment side until I was in a hotel restaurant in Bentonville, AR, on a work trip,
                    following my son&apos;s baseball game pitch by pitch on GameChanger. I couldn&apos;t be there,
                    and that wasn&apos;t great, but the app helped me be there in spirit.
                  </p>
                  <p>
                    I keep coming back to that. You&apos;re repositioning from a scorekeeping app to a live
                    sports media platform, and Lauren Hobart is already using that language publicly.
                    That&apos;s a significant brand opportunity, and the storytelling needs to be on point
                    to make that transition land. I&apos;ve spent my career on exactly that problem.
                    Working on it for something families already love is a different kind of opportunity.
                  </p>
                </div>
              </details>
              ...
              <details className="gc-qa-item">
                <summary className="gc-qa-question">
                  <span>How do you use AI in your work?</span>
                  <span className="gc-qa-chevron">▾</span>
                </summary>
                <div className="gc-qa-answer">
                  <p>
                    A client needed a new website. Instead of updating a WordPress template,
                    I built a fully custom site with a CMS he&apos;d actually use and GA4 wired in
                    from the start. I don&apos;t write code, but I built it using Claude Code to
                    direct AI agents through the entire process. The site now dramatically outperforms
                    the old one on every benchmark.
                  </p>
                  <p>
                    That changed how I think about AI. It is not just a speed tool; it is a thought
                    partner that opens possibilities that weren&apos;t accessible before without technical
                    skills. I now build my own marketing automations in Zapier and n8n, run a personal
                    CRM I built from scratch, and can go from concept to working prototype in a few hours.
                    I also served on the AI Governance Team at Central Garden &amp; Pet, so I&apos;ve seen
                    both sides: what AI unlocks, and why guardrails are a necessary part of any deployment.
                  </p>
                </div>
              </details>
        ...
        <section id="bring" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              I set strategy and then get into the work alongside the team. That player-coach approach
              is how I&apos;ve built brands that are culturally relevant and deliver business results.
            </p>
            <dl className="mb-capability-list">
              <div className="mb-capability-row">
                <dt>Leadership &amp; Scale</dt>
                <dd>Led and unified a 25-person marketing organization spanning Consumer Insights, Digital, Creative, Innovation, and Customer Marketing. Built the Innovation function within it from the ground up.</dd>
              </div>
              <div className="mb-capability-row">
                <dt>Creative Excellence</dt>
                <dd>Clio Award-winning campaigns. 3.95B impressions. 10-point brand awareness lifts. Strategy-grounded emotional creative that earns more attention than what was bought.</dd>
              </div>
              <div className="mb-capability-row">
                <dt>Social-First Brand Building</dt>
                <dd>Deep experience building brands organically through culturally resonant content, creator partnerships, and community activation. Platform fluency across the full modern media landscape.</dd>
              </div>
              <div className="mb-capability-row">
                <dt>Data-Driven Marketing</dt>
                <dd>Marketing Mix Modeling, attribution frameworks, KPI dashboards. 25% efficiency gains through optimization. AI-enabled workflow and content automation via Zapier and n8n.</dd>
              </div>
              <div className="mb-capability-row">
                <dt>Brand Strategy &amp; Positioning</dt>
                <dd>Defined and scaled brand voice, creative systems, and storytelling frameworks across multi-brand portfolios and teams. CPG-trained foundation with proven application in high-growth environments.</dd>
              </div>
              <div className="mb-capability-row">
                <dt>Cross-Functional Leadership</dt>
                <dd>Player-coach style. Agency selection and management. Change management across matrixed organizations. Experienced partnering with Product, Growth, Sales, and Communications.</dd>
              </div>
            </dl>
          </div>
        </section>
        ...
        <section id="work" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              From Clio-winning creative to product innovation that won Walmart distribution,
              here is a selection of marketing work that delivered measurable impact and cultural resonance.
            </p>
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Challenge:</strong> Grass seed is the ultimate low-involvement purchase.
                Yet artificial turf was causing a surge in player injuries, and Pennington had no
                natural platform to enter the national sports conversation. The brand needed to make
                millions of people suddenly care about something they had never thought twice about.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> Partner with NFL star Von Miller on a deliberately
                provocative anti-turf campaign designed to get banned by the league. The NFL&apos;s
                censorship became free media coverage, sparking a grassroots movement among players and fans.
              </p>
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                <strong>The Insight:</strong> Millennial homeowners did not understand, and did not
                want to commit to, the traditional 4-step fertilizer program promoted by the category leader.
                The complexity was a real barrier, leaving a significant segment underserved.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> Used that insight to define and develop a genuinely
                differentiated product: Full Season, a one-application-per-season fertilizer that
                eliminated the complexity entirely. Led cross-functional development and go-to-market
                strategy, built the business case for Walmart, and won distribution. Walmart&apos;s
                own sales data confirmed Full Season indexed higher with Millennial shoppers than the
                competition, creating a platform for additional extensions.
              </p>
              <div className="campaign-media-grid campaign-media-grid--2col" style={{ marginBottom: "2rem" }}>
                <div className="media-item">
              ...
              <div className="campaign-results">
                ...
                <div className="results-grid">
                  ...
                  <div className="result-stat">
                    ...
                    <div className="result-stat-label">Incremental Revenue, Home Depot Pitch</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="campaign-card">
              ...
              <p className="campaign-description">
                <strong>The Challenge:</strong> In a commoditized baby care aisle, Johnson&apos;s Baby
                needed to reinforce its emotional equity while driving meaningful sales lift.
              </p>
              <p className="campaign-description">
                <strong>The Approach:</strong> An Olympic campaign where athletes thanked their mothers
                on the world stage. The storytelling was so compelling that Debbie Phelps, Michael Phelps&apos;
                mom, asked to participate. The emotional resonance extended the campaign well beyond paid
                placements into earned and shared media.
              </p>
              <div className="campaign-media-grid campaign-media-grid--2col" style={{ marginBottom: "2rem" }}>
                <div className="media-item">
            ...
            <div className="mb-experience-grid">
              ...
              <div className="mb-exp-card">
                <div className="mb-exp-logo-wrap">
                  ...
                  >
                    ...
                    <path fill="#006e43" d="M206.88,100.67l-5.65,13.65H203l1.26-3.17h7.21l1.27,3.17h1.74l-5.64-13.65Zm-2.10,9.06,3.07-7.33,3.07,7.33Z" />
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Led marketing for the $1.5B Garden segment. Unified and led a 25-person team
                    spanning Consumer Insights, Digital, Creative, Innovation, and Customer Marketing.
                    Full responsibility for brand development and marketing plans across a multi-brand portfolio.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    Consumer and Medical Device divisions. Multiple brands, $80MM+ portfolio responsibility.
                    Award-winning campaigns including the Thanks, Mom Olympic activation.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    Built a foundation in technology, complex B2B sales cycles, and operational excellence.
                  </p>
                </div>
              </div>
            ...
            <div className="mb-education-row" style={{ marginTop: "1.5rem" }}>
              <div className="mb-edu-card">
                ...
                <div className="mb-edu-text">
                  ...
                  #FlipTheTurf · Central Garden &amp; Pet / Pennington Grass Seed
                </div>
              </div>
              <div className="mb-edu-card">
                <div className="mb-edu-logo" style={{ fontSize: "2rem", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <div className="mb-edu-text">
                  ...
                  Thanks, Mom · Johnson &amp; Johnson Baby Care
                </div>
              </div>
            </div>
        ...
        <section className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              I learn by building. Without writing code, I have developed these apps by asking questions,
              iterating, and fixing mistakes. Along the way I built a genuine sense for where AI delivers
              real value and where it does not.
            </p>
            <div className="gc-projects-grid">
              ...
              <div className="gc-project-card">
                ...
                <div className="gc-project-body">
                  ...
                  <p className="gc-project-desc">
                    A triathlon training app for better visibility into swim, bike, and run training.
                    Built to scratch my own itch for data that Strava does not surface.
                  </p>
                  <div className="gc-project-tech">Next.js · Supabase · TypeScript · APIs</div>
                  <a href="https://raceprep.kineticbrandpartners.com/" className="kinetic-btn kinetic-btn--secondary gc-project-btn" target="_blank" rel="noopener noreferrer">
                    View Live →
                  </a>
                </div>
              </div>
              ...
              <div className="gc-project-card">
                ...
                <div className="gc-project-body">
                  ...
                  <p className="gc-project-desc">
                    A CRM-style app for tracking every contact and connection in a job search.
                    Job hunting is about networking smarter, not applying more.
                  </p>
                  <div className="gc-project-tech">Next.js · Supabase · OAuth · n8n</div>
                  <a href="https://job-tracker.kineticbrandpartners.com/" className="kinetic-btn kinetic-btn--secondary gc-project-btn" target="_blank" rel="noopener noreferrer">
                    View Live →
                  </a>
                </div>
              </div>
              ...
              <div className="gc-project-card">
                ...
                <div className="gc-project-body">
                  ...
                  <p className="gc-project-desc">
                    A dashboard for measuring key SaaS KPIs and stress-testing assumptions.
                    Tailors views by role and surfaces what actually matters.
                  </p>
                  <div className="gc-project-tech">Next.js · TypeScript · Netlify</div>
                  <a href="https://saas-metrics-calculator.netlify.app/" className="kinetic-btn kinetic-btn--secondary gc-project-btn" target="_blank" rel="noopener noreferrer">
                    View Live →
                  </a>
                </div>
              </div>
        ...
        <section className="kinetic-section">
          <div className="kinetic-container">
            <div className="kinetic-section-header">
              <span className="kinetic-section-badge">Beyond the Resume</span>
              <h2 className="kinetic-section-title">The Whole Person</h2>
            </div>

            {/* Triathlon */}
            <div className="gc-whole-row">
              <div className="gc-whole-content">
                <h3 className="gc-whole-heading">Triathlon</h3>
                <p className="gc-whole-text">
                  Half and full Ironman distances. FOMO got me into it; the finish line kept me coming back.
                  There is nothing like a race on the calendar to focus your training. The sport demands
                  commitment across three disciplines at once, which turns out to be good practice for
                  running a multi-team marketing organization.
                </p>
              </div>
              <div className="gc-whole-visual">
                <picture>
                  <source type="image/webp" srcSet="/images/Ironman-sketch-mobile.webp 400w, /images/Ironman-sketch-560.webp 560w, /images/Ironman-sketch.webp 800w" sizes="(max-width: 768px) 90vw, 420px" />
                  <img src="/images/Ironman-sketch.png" alt="Ironman triathlon" width={420} height={630} className="gc-whole-img" loading="lazy" decoding="async" />
                </picture>
              </div>
            </div>

            {/* Swimming */}
            <div className="gc-whole-row gc-whole-row--reverse">
              <div className="gc-whole-content">
                <h3 className="gc-whole-heading">Collegiate Swimming</h3>
                <p className="gc-whole-text">
                  Walked on to the Clemson swim team. Four-year letterman, co-captain senior year.
                  I learned firsthand that determination consistently outpaces natural talent,
                  and that is the only reason I made it as far as I did.
                  This sport gave me lifelong friends, a strong work ethic, and a love for the water.
                </p>
              </div>
              <div className="gc-whole-visual">
                <picture>
                  <source type="image/webp" srcSet="/images/Clemson-swimming-sketch-mobile.webp 400w, /images/Clemson-swimming-sketch-560.webp 560w, /images/Clemson-swimming-sketch.webp 800w" sizes="(max-width: 768px) 90vw, 420px" />
                  <img src="/images/Clemson-swimming-sketch.png" alt="Clemson swimming" width={420} height={630} className="gc-whole-img" loading="lazy" decoding="async" />
                </picture>
              </div>
            </div>
            ...
            <div className="gc-whole-row">
              <div className="gc-whole-content">
                <h3 className="gc-whole-heading">Family</h3>
                <p className="gc-whole-text">
                  Three kids, an amazing wife, and two doodles. The oldest is heading to college soon,
                  which is impossible to believe. Youth sports are not an abstraction in this house.
                  GameChanger has been on my phone for years, not as research, but because it is how
                  I stay connected to games I cannot make it to in person.
                </p>
              </div>
              <div className="gc-whole-visual">
                <picture>
                  <source type="image/webp" srcSet="/images/family-sketch-mobile.webp 400w, /images/family-sketch-560.webp 560w, /images/family-sketch.webp 800w" sizes="(max-width: 768px) 90vw, 420px" />
                  <img src="/images/family-sketch.png" alt="Family" width={420} height={280} className="gc-whole-img" loading="lazy" decoding="async" />
                </picture>
              </div>
            </div>
