// LocumTenens.com Candidate Page
// Live at: kineticbrandpartners.com/locumtenens
// Golden Thread: Player-Coach Builder
// Colors: Primary #336195, Secondary #0076bb, Accent #00953b
...
export const metadata = {
  title: "LocumTenens.com | Dan Hoeller",
  description:
...
export default function LocumTenensPage() {
  return (
    <div className="kinetic-page locumtenens-page">
      <GradientMesh />

      <header className="kinetic-header lt-header" aria-label="Page sections">
        <div className="kinetic-container">
          <a href="#top" className="lt-header-brand" aria-label="Back to top">
            <img
              src="/locumtenens/locumtenens-logo.svg"
              alt="LocumTenens.com"
              height={32}
            />
          </a>
      ...
      <main id="top">
          ...
          <div className="kinetic-container">
            <div className="mb-hero-grid">
              <div className="mb-hero-content">
                {/* LocumTenens logo */}
                <div className="lt-hero-logo animate-slide-up delay-1">
                  <img
                    src="/locumtenens/locumtenens-logo.svg"
                    alt="LocumTenens.com"
                    height={52}
                ...
                >
                  ...
                  VP Marketing Candidate · Atlanta, GA
                </div>
                ...
                <p className="mb-subtitle animate-slide-up delay-3">
                  ...
                  and never losing sight of the consumer or customer.
                </p>
        ...
        {/* ===================================================================
            SECTION 2: DISC PROFILE
            =================================================================== */}
        <section id="disc" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left">
              What the DISC says
            </h2>
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              It's amazing how a 15 minute assessment can accurately pinpoint
              your working styles. Below is how I interpret them for the role at
              LocumTenens.com.
            </p>

            <div className="disc-profile">
              {/* Style scores */}
              <div className="disc-style-card">
                <div className="disc-style-label">Natural Style</div>
                <div className="disc-style-name">Supporting Relater</div>
                <div className="disc-scores">
                  <div className="disc-score-bar">
                    <span className="disc-letter">D</span>
                    <div className="disc-bar-track">
                      <div
                        className="disc-bar-fill disc-bar--d"
                        style={{ width: "45%" }}
                      ></div>
                    </div>
                    <span className="disc-score-num">45</span>
                  </div>
                  <div className="disc-score-bar">
                    <span className="disc-letter">I</span>
                    <div className="disc-bar-track">
                      <div
                        className="disc-bar-fill disc-bar--i"
                        style={{ width: "62%" }}
                      ></div>
                    </div>
                    <span className="disc-score-num">62</span>
                  </div>
                  <div className="disc-score-bar">
                    <span className="disc-letter">S</span>
                    <div className="disc-bar-track">
                      <div
                        className="disc-bar-fill disc-bar--s"
                        style={{ width: "68%" }}
                      ></div>
                    </div>
                    <span className="disc-score-num">68</span>
                  </div>
                  <div className="disc-score-bar">
                    <span className="disc-letter">C</span>
                    <div className="disc-bar-track">
                      <div
                        className="disc-bar-fill disc-bar--c"
                        style={{ width: "36%" }}
                      ></div>
                    </div>
                    <span className="disc-score-num">36</span>
                  </div>
                </div>
                <p className="disc-style-note">
                  Natural and adapted styles are nearly identical; I'm the same
                  person in the interview as I am in the office.
                </p>
              </div>

              {/* Trait observations */}
              <div className="disc-traits-grid">
                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">I finish things.</h3>
                  <p className="disc-trait-text">
                    My highest behavioral hierarchy score is persistence (73),
                    and I love that. It's a skill I developed in the pool to
                    become a walk-on D1 swimmer at Clemson. It led me to take on
                    one of the more rigorous MBA programs and pivot my career
                    from software to marketing. At Central Garden & Pet, I led a
                    rebrand of the largest equity in the company portfolio that
                    opened up new product lines and drove sales 4x faster than
                    the category. None were easy, but I play the long game.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">
                    I listen before I decide.
                  </h3>
                  <p className="disc-trait-text">
                    The DISC describes me as someone who thinks over major
                    decisions before acting and prefers to analyze situations
                    personally before committing. I've seen leaders act like
                    they had all the answers and ignore institutional knowledge.
                    Those are the people who flame out and don't achieve their
                    objectives. My instinct is to gather the data, hear
                    different perspectives, and then make the decision. That
                    gains alignment and is the only way to make positive,
                    lasting, change.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">People talk to me.</h3>
                  <p className="disc-trait-text">
                    Customer-oriented is my top behavioral hierarchy dimension
                    (63), and Influence is my second highest DISC score (62).
                    Together, this means I'm sociable, trusting, and able to use
                    emotional appeal, which is exactly how I was trained as a
                    CPG / B2B2C marketer at Johnson & Johnson. I can have a real
                    conversation with a clinician, a sales rep, a hospital
                    administrator, and an EVP all in the same day and not have
                    it feel like four different performances.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">
                    My work has always centered on people's lives.
                  </h3>
                  <p className="disc-trait-text">
                    The DISC describes me as patient and empathetic, and I think
                    that shows up in the work I've gravitated toward. At J&J,
                    the marketing mattered because it helped mothers feel
                    confident caring for the people they loved most. At Central
                    Garden and Pet, it was about giving people a backyard worth
                    living in, and making sure the kids playing on those fields
                    were safe doing it. Healthcare staffing sits in that same
                    territory. It's about whether people get access to quality
                    care.
                  </p>
                </div>
                ...
                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">
                    Once I decide, I'm committed.
                  </h3>
                  <p className="disc-trait-text">
                    The report describes me as tough-minded and unbending after
                    a decision is made. In a VP of Marketing role, that's
                    usually a good thing as you can't run a brand strategy if
                    the direction changes constantly. The flip side is that I
                    can be slow to make a decision in certain situations. To
                    address that, I've learned to consider whether the decision
                    is a 'one-way door' or a 'two-way door.' The former requires
                    more consideration whereas the latter can be reversed
                    relatively easily as new information is available.
                  </p>
                </div>

                <div className="disc-trait-card">
                  <h3 className="disc-trait-title">
                    One honest flag from the report.
                  </h3>
                  <p className="disc-trait-text">
                    The areas for improvement section notes I can have trouble
                    establishing priorities when too many things feel equally
                    important. I think that's pretty fair, and I've learned to
                    work closely with my management to align priorities in
                    advance and surface issues that will impact that list. At
                    Central I would develop priorities with the Garden president
                    at the beginning of the year, and worked with him to
                    reprioritize when budget cuts meant that the team would not
                    have the resources to accomplish all original objectives.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="bring" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              A player-coach builds the capability, then stays close enough to
              the work to identify issues before they become major headaches.
            </p>
            <dl className="mb-capability-list">
              <div className="mb-capability-row">
                <dt>Leadership &amp; Scale</dt>
                <dd>
                  Led a 25-person marketing org spanning Insights, Digital,
                  Creative, Innovation, and Customer Marketing. Built the
                  Innovation team from scratch to focus on bigger bets.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>P&amp;L Ownership</dt>
                <dd>
                  ...
                  EBIT. Full budget authority and accountability for outcomes.
                </dd>
              </div>
              <div className="mb-capability-row">
                <dt>Data-Driven Marketing</dt>
                <dd>
                  Marketing Mix Modeling, attribution, KPI dashboards. 25%
                  efficiency gains through media plan optimization.
                </dd>
              </div>
              <div className="mb-capability-row">
              ...
              <div className="mb-capability-row">
                ...
                <dd>
                  ...
                  management across matrixed orgs. Sales alignment and
                  enablement.
                </dd>
              </div>
            </dl>
        ...
        {/* ===================================================================
            SECTION 3.5: WHAT I'M HEARING
            =================================================================== */}
        <section id="hearing" className="kinetic-section lt-section--tint">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left">
              What I'm Hearing
            </h2>
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              A few themes from conversations during my 4/13 visit, and where I see the biggest opportunities to make an outsized difference.
            </p>

            <div className="disc-traits-grid">
              <div className="disc-trait-card">
                <h3 className="disc-trait-title">
                  Marketing needs a seat at the sales table (and vice versa).
                </h3>
                <p className="disc-trait-text">
                  Marketing is often reactive to opportunities and/or can be
                  brought in to execute after decisions are made. That doesn't
                  set up Marketing for success or lead to the best outcomes...and that
                  impacts the quality that clinicians and health systems receive.
                  Marketing can build bridges to Sales by joining customer calls,
                  embedding in account reviews, and treating Sales feedback as primary
                  research. Sales can get involved earlier in the process by helping shape
                  campaign strategy, validating messaging, and co-owning the narrative
                  with customers.
                </p>
              </div>
              ...
              <div className="disc-trait-card">
                <h3 className="disc-trait-title">
                  Quality is the real competitive story.
                </h3>
                <p className="disc-trait-text">
                  Presenting one or two deeply vetted candidates while
                  competitors send ten represents an opportunity to position
                  LT as a premium staffing company. While price might be the 
                  most common objection in the sales process,
                  LT can lean into the value provided. Tenured recruiters with deep
                  specialization, paired with extensive vetting, means the facility 
                  doesn't waste time reviewing candidates who aren't a good fit. 
                  That has the markings of a brand platform and a place to be proud of.
                </p>
              </div>

              <div className="disc-trait-card">
                <h3 className="disc-trait-title">
                  Kimedics and Inlightened need a positioning story.
                </h3>
                <p className="disc-trait-text">
                  LT is moving beyond temporary staffing, with recent acquisitions in
                  workforce management and on-demand clinical consultation. 
                  This complicates branding because Kimedics and Inlightened
                  solve different problems than the core business. 
                  Forcing it under a brand synonymous with temp staffing limits their opportunity. Leaving them
                  as-is limits LT's ability to play a more strategic role 
                  in the c-suites of large customers. The unlock is in developing a strategic
                  branding architecture and then building distinct narratives for
                  each. 
                </p>
              </div>
              ...
              <div className="disc-trait-card">
                <h3 className="disc-trait-title">
                  Sales needs the tools to sell the full portfolio.
                </h3>
                <p className="disc-trait-text">
                  The team excels at the traditional staffing model. They're less
                  certain on how to capitalize on emerging opportunities such as
                  telehealth, PE-anesthesia transition management, and other
                  ancillary services that are important to core customers. Developing battle cards and personas
                  is a great start to building an organizational muscle
                  where Sales is ready to make the pitch outside of temp staffing solutions, but
              ...
              <div className="disc-trait-card">
                <h3 className="disc-trait-title">
                  Anesthesia is the growth engine to protect and expand.
                </h3>
                <p className="disc-trait-text">
                  Building the Anesthesia practice from $60MM to $500MM in six years 
                  isn't a flash in the pan. With the supply-demand
                  imbalance not resolving until the mid-2030s, Marketing's
                  job here is to bolster the brand's premium position in this business line and sharpen the
                  clinician value proposition against a backdrop of surgery center 
                  alternatives.
                </p>
              </div>
              ...
              <div className="disc-trait-card">
                <h3 className="disc-trait-title">
                  The buying center is changing, and the go-to-market should too.
                </h3>
                <p className="disc-trait-text">
                  When C-suite, supply chain, and procurement are increasingly
                  making the call, staffing leaders alone aren't the audience
                  anymore, and can even be cut out of the decision. That
                  changes the content, channels, and which relationships need
                  nurturing. The JPS co-sell gives LT an
                  entry point; marketing's job is to make sure there's a
                  compelling story that drives the conversation.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* ===================================================================
            ...
            =================================================================== */}
        <section id="work" className="kinetic-section">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left">
              Making An Impact On The Business
            </h2>
            <p className="mb-subtitle" style={{ marginBottom: "2.5rem" }}>
              From Clio-winning creative to data-driven product innovation, here
              is a selection of marketing work that delivered measurable impact
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                ...
                surge in player injuries, and Pennington had no natural platform
                to enter the national sports conversation. The brand needed to
                make millions of people suddenly care about something they'd
            ...
            <div className="campaign-card" style={{ marginBottom: "3rem" }}>
              ...
              <p className="campaign-description">
                ...
                fertilizer program promoted by the category leader. Complexity
                was a barrier, leaving a significant segment underserved.
              </p>
              <p className="campaign-description">
                ...
                development and go-to-market strategy, built the business case
                for Walmart, and won distribution. Walmart's own data confirmed
                the insight.
              </p>
              <div className="campaign-media-grid campaign-media-grid--2col">
                <div className="media-item">
            ...
            <div className="campaign-card">
              ...
              <p className="campaign-description">
                <strong>The Approach:</strong> Two paths. Drive reach and
                relevance with "Thanks Mom," an Olympic campaign where athletes
                thanked their mothers on the world stage -- so compelling that
                Debbie Phelps, Michael Phelps' mom, asked to participate. And
                reinforce the brand's deep equity through emotional print
                campaigns and digital activations outside the Olympics.
              </p>
        ...
        {/* ===================================================================
            ...
            =================================================================== */}
        <section id="background" className="kinetic-section kinetic-section--gray">
          <div className="kinetic-container">
            <h2 className="kinetic-section-title mb-section-title--left">
              Where I've Worked
            </h2>
              ...
              <div className="mb-exp-card">
                <div className="mb-exp-logo-wrap">
                  ...
                  >
                    <path
                      fill="#006e43"
                      d="M188.19,108.36h4.45v4a7.31,7.31,0,0,1-3.3.62c-3.77,0-6.24-2.22-6.24-5.48s2.45-5.43,6.22-5.43a10.07,10.07,0,0,1,4.26,1l.15-1.58a10,10,0,0,0-4.39-1c-4.81,0-8,2.85-8,7s3.21,7,8,7a9.85,9.85,0,0,0,4.85-1.13v-6.53h-6.07Z"
                    />
                    <path
                      fill="#006e43"
                      d="M206.88,100.67l-5.65,13.65H203l1.26-3.17h7.21l1.27,3.17h1.74l-5.64-13.65Zm-2.10,9.06,3.07-7.33,3.07,7.33Z"
                    />
                    <path
                      fill="#006e43"
                      d="M232.68,105.38c0-3.23-2.2-4.71-4.77-4.71h-6v13.65h1.66V110h4.34l3.44,4.28h2.08l-3.76-4.57A4.43,4.43,0,0,0,232.68,105.38Zm-5,3.16h-4.18v-6.36h4.18a3,3,0,0,1,3.26,3.21A3.09,3.09,0,0,1,227.72,108.54Z"
                    />
                    <path
                      fill="#006e43"
                      d="M246.72,100.67h-5.59v13.65h5.57c4.57,0,6.91-2.63,6.91-6.82C253.61,103.47,251.28,100.67,246.72,100.67Zm-.10,12.13h-3.83V102.18h3.83c3.53,0,5.3,2,5.3,5.32S250.15,112.8,246.62,112.8Z"
                    />
                    <polygon
                      fill="#006e43"
                      points="263.59 108.06 270.67 108.06 270.67 106.55 263.59 106.55 263.59 102.17 271.72 102.17 271.72 100.67 261.93 100.67 261.93 114.32 271.93 114.32 271.93 112.82 263.59 112.82 263.59 108.06"
                    />
                    <polygon
                      fill="#006e43"
                      points="290.9 111.86 281.62 100.67 279.88 100.67 279.88 114.32 281.55 114.32 281.55 103.17 290.82 114.32 292.56 114.32 292.56 100.67 290.9 100.67 290.9 111.86"
                    />
                    <path
                      fill="#006e43"
                      d="M323,106.9h-1.53a6.48,6.48,0,0,1-.9,4l-4.44-4.19c-1-1-1.58-1.6-1.58-2.81s1.27-2,2.86-2a7.06,7.06,0,0,1,2.9.63l.2-1.46a8.24,8.24,0,0,0-3.12-.62c-2.49,0-4.47,1.25-4.47,3.46a4,4,0,0,0,1.18,2.78,4.4,4.4,0,0,0-2.6,3.72c0,2.43,2.13,4.1,5.1,4.1a5.86,5.86,0,0,0,4.08-1.5l1.38,1.3h2.23l-2.56-2.44A7.91,7.91,0,0,0,323,106.9ZM316.57,113c-2,0-3.48-1.06-3.48-2.62a3,3,0,0,1,1.82-2.71l4.63,4.26A4.16,4.16,0,0,1,316.57,113Z"
                    />
                    <path
                      fill="#006e43"
                      d="M348.12,100.67h-6v13.65h1.66V110h4.38a4.54,4.54,0,0,0,4.76-4.66A4.41,4.41,0,0,0,348.12,100.67Zm-.19,7.87h-4.19v-6.36h4.19a3,3,0,0,1,3.25,3.21A3.08,3.08,0,0,1,347.93,108.54Z"
                    />
                    <polygon
                      fill="#006e43"
                      points="362.4 108.06 369.48 108.06 369.48 106.55 362.4 106.55 362.4 102.17 370.54 102.17 370.54 100.67 360.75 100.67 360.75 114.32 370.75 114.32 370.75 112.82 362.4 112.82 362.4 108.06"
                    />
                    <polygon
                      fill="#006e43"
                      points="377.68 102.21 382.25 102.21 382.25 114.32 383.9 114.32 383.9 102.21 388.47 102.21 388.47 100.67 377.68 100.67 377.68 102.21"
                    />
                    <polygon
                      fill="#006e43"
                      points="227.33 82.19 210.19 82.19 210.19 74.8 223.6 74.8 223.6 68.02 210.19 68.02 210.19 61.03 226.65 61.03 225.39 54.36 202.18 54.36 202.18 88.87 226.06 88.87 227.33 82.19"
                    />
                    <polygon
                      fill="#006e43"
                      points="263.87 54.36 256 54.36 256 76.45 241.81 54.36 233.68 54.36 233.68 88.87 241.55 88.87 241.55 66.78 255.64 88.87 263.87 88.87 263.87 54.36"
                    />
                    <polygon
                      fill="#006e43"
                      points="270.14 54.36 268.97 61.03 279.16 61.03 279.16 88.87 288 88.87 288 61.03 298.51 61.03 297.11 54.36 270.14 54.36"
                    />
                    <polygon
                      fill="#006e43"
                      points="388.8 82.19 388.8 54.36 380.78 54.36 380.78 88.87 403.9 88.87 405.17 82.19 388.8 82.19"
                    />
                    <path
                      fill="#006e43"
                      d="M193.57,87.52V79.71a16.94,16.94,0,0,1-9.66,2.79c-5.75,0-11.18-3.51-11.18-10.86,0-6.83,4.66-10.92,11.38-10.92,6.06,0,9.26,2.33,9.46,2.48v-8a28.32,28.32,0,0,0-9.25-1.42c-12.21,0-19.66,8.17-19.66,18.62,0,11.28,8.74,17.13,18.78,17.13A24.55,24.55,0,0,0,193.57,87.52Z"
                    />
                    <path
                      fill="#006e43"
                      d="M360.92,54.36h-7.79l-8,21.57h-4.28l-2.48,6.7h4.29l-2.3,6.24h7.92l2.17-6.21h12.88l2.17,6.21h8.13Zm-8.11,21.57,4.08-11.69L361,75.93Z"
                    />
                    <path
                      fill="#006e43"
                      d="M326.1,75.83A12.29,12.29,0,0,0,328,75c3.35-1.88,5-5,5-9.44,0-11.2-10.93-11.2-12.93-11.2H304V88.87h8V76.76h5.43l7.67,12.11h9.52Zm-3.8-5.74H312V61H322.3l3,4.53Z"
                    />
                    <path
                      fill="#006e43"
                      d="M51.09,116.33h4V73.18a51.63,51.63,0,0,0-4,43.15Z"
                    />
                    <path
                      fill="#006e43"
                      d="M60.31,65.77v50.56h7V58.94A51.64,51.64,0,0,0,60.31,65.77Z"
                    />
                    <path
                      fill="#006e43"
                      d="M106,70.56l4.72-3.14L151.12,94.2a52.05,52.05,0,0,0-1.82-9.57L117.06,63.24l4.73-3.13L146,76.17a51.84,51.84,0,0,0-17.31-19.84l-.29-.2a52.43,52.43,0,0,0-5.23-3.05c-.65-.33-1.3-.65-2-.95L79.46,79.83V73.56l35.79-23.74a52,52,0,0,0-9.56-2L79.46,65.2V58.93L96.62,47.55A51.35,51.35,0,0,0,73.36,54.7l-.86.52v61.11h7V88.19L99.74,74.74,120,88.19v28.14h7V92.81l5.22,3.46v20.06h7V100.9l5.22,3.46v12h4a51.28,51.28,0,0,0,2.11-7.92,52.72,52.72,0,0,0,.82-7.81Z"
                    />
                    <rect
                      fill="#006e43"
                      x="95.37"
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    25-person team across Insights, Innovation, Digital,
                    Creative, Customer Marketing, and Customer Care. Full
                    responsibility for brand development and marketing plans
                    across multi-brand portfolio.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    $80MM+ portfolio responsibility. Built consumer insights
                    processes, new product development frameworks, and
                    award-winning campaigns across B2C and professional
                    channels.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-exp-card">
                ...
                <div className="mb-exp-content">
                  ...
                  <p className="mb-exp-desc">
                    ...
                    cycles, and operational excellence before transitioning to
                    marketing.
                  </p>
                </div>
              </div>
        ...
        <section id="contact" className="kinetic-section">
          <div className="kinetic-container">
            ...
            <p className="mb-subtitle" style={{ marginBottom: "2rem" }}>
              Let's keep the conversation going and talk about what's next.
            </p>
            <div
              style={{
                display: "flex",
